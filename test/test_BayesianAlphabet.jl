...
for single_step in [false,true]
      for test_method in ["BayesA","BayesB","BayesC","RR-BLUP","BayesL","GBLUP","conventional (no markers)"]
...
if ispath("mytest_deprecated") == true
      rm("mytest_deprecated", recursive=true)
end
