...
phenofile     = Datasets.dataset_big("phenotypes.txt")
pedfile       = Datasets.dataset_big("pedigree.txt")
genofile      = Datasets.dataset_big("genotypes_5k.txt")
genofile_ssbr = Datasets.dataset_big("genotypes_2kind.txt")
#mapfile    = Datasets.dataset_big("map.txt")
...
#PA_df = DataFrame(PredictionAccuracy = collect(values(PA_dict)), Methods = collect(keys(PA_dict)))
#CSV.write("./../src/4.Datasets/data/PA_bigdata.csv", PA_df)
